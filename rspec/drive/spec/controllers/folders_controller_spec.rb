...
RSpec.describe FoldersController, type: :controller do
  ...
  describe "GET #index" do
    context "Creating a Folder with valid user" do
  ...
  describe "GET #show" do
    context "Showing a Folder for valid id" do
      it "returns a success response" do
        get :show, params: {id: folder.to_param}, session: valid_session
        expect(response).to be_success
      end
    end
    context "Showing a Folder for in-valid id" do
      it "returns a Error response code" do
  ...
  describe "GET #edit" do
    context "Edit a Folder for in-valid id" do
      it "returns a success response" do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Folder" do
        expect {
          post :create, params: {id: folder.to_param}, session: valid_session
